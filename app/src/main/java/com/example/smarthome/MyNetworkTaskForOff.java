...
public class MyNetworkTaskForOff {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a1jdp1fi6njxnj-ats.iot.us-east-1.amazonaws.com";
    // Filename of KeyStore file on the filesystem
    private static final String KEYSTORE_NAME = "debug.bks"; //"iot_keystore";
    // Password for the private key in the KeyStore
    private static final String KEYSTORE_PASSWORD = "gauri1234";
    ...
    void initIoTClient() {
        ...
        keystorePath =  this.myContext.getObbDir().getPath();
